...
module DatPath(	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7]
  ...
  `ifndef SYNTHESIS	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:131:10]
    always @(posedge clock) begin	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:131:10]
      if (~reset & io_imem_resp_valid & ~_if_buffer_out_q_io_enq_ready) begin	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:131:{10,32,35}, src/main/scala/chisel3/util/Decoupled.scala:362:21]
        if (`ASSERT_VERBOSE_COND_)	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:131:10]
          $error("Assertion failed: Instruction backlog\n    at dpath.scala:131 assert(!(if_buffer_in.valid && !if_buffer_in.ready), \"Instruction backlog\")\n");	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:131:10]
        if (`STOP_COND_)	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:131:10]
          $fatal;	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:131:10]
      end
      if ((`PRINTF_COND_) & ~reset)	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:131:10, :520:10]
        $fwrite(32'h80000002, "Cyc= %d [%d] pc=[%x] W[r%d=%x][%d] Op1=[r%d][%x] Op2=[r%d][%x] inst=[%x] %c%c%c DASM(%x)\n", _csr_io_time, wb_reg_valid, REG, wb_reg_wbaddr, wb_reg_wbdata, wb_reg_ctrl_rf_wen, REG_1, REG_2, REG_3, REG_4, wb_reg_inst, io_ctl_pipeline_kill ? 8'h4B : io_ctl_full_stall ? 8'h46 : io_ctl_dec_stall ? 8'h53 : 8'h20, _if_pc_next_T ? 8'h20 : (&io_ctl_exe_pc_sel) ? 8'h45 : {3'h2, _io_dat_exe_inst_misaligned_T_6, 4'h2}, io_ctl_mem_exception ? 8'h58 : 8'h20, wb_reg_inst);	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:114:39, :115:35, :116:35, :117:39, :163:40, :165:40, :427:20, :518:29, :520:10, :523:14, :527:14, :528:14, :529:14, :530:14, :536:45, :541:10, src/main/scala/chisel3/util/Mux.scala:126:16]
    end // always @(posedge)
  `endif // not def SYNTHESIS
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7]
    `ifdef FIRRTL_BEFORE_INITIAL	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7]
      `FIRRTL_BEFORE_INITIAL	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7]
    `endif // FIRRTL_BEFORE_INITIAL
    logic [31:0] _RANDOM[0:23];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7]
    initial begin	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7]
      `ifdef INIT_RANDOM_PROLOG_	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7]
        `INIT_RANDOM_PROLOG_	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7]
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7]
        for (logic [4:0] i = 5'h0; i < 5'h18; i += 5'h1) begin
          _RANDOM[i] = `RANDOM;	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7]
        end	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7]
        if_reg_pc = _RANDOM[5'h0];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :68:39]
        dec_reg_valid = _RANDOM[5'h1][0];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :71:39]
        dec_reg_inst = {_RANDOM[5'h1][31:1], _RANDOM[5'h2][0]};	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :71:39, :72:39]
        dec_reg_pc = {_RANDOM[5'h2][31:1], _RANDOM[5'h3][0]};	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :72:39, :73:39]
        exe_reg_valid = _RANDOM[5'h3][1];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :73:39, :76:39]
        exe_reg_inst = {_RANDOM[5'h3][31:2], _RANDOM[5'h4][1:0]};	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :73:39, :77:39]
        exe_reg_pc = {_RANDOM[5'h4][31:2], _RANDOM[5'h5][1:0]};	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :77:39, :78:39]
        exe_reg_wbaddr = _RANDOM[5'h5][6:2];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :78:39, :79:35]
        exe_reg_rs1_addr = _RANDOM[5'h5][11:7];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :78:39, :80:35]
        exe_reg_rs2_addr = _RANDOM[5'h5][16:12];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :78:39, :81:35]
        exe_reg_op1_data = {_RANDOM[5'h5][31:17], _RANDOM[5'h6][16:0]};	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :78:39, :82:35]
        exe_reg_op2_data = {_RANDOM[5'h6][31:17], _RANDOM[5'h7][16:0]};	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :82:35, :83:35]
        exe_reg_rs2_data = {_RANDOM[5'h7][31:17], _RANDOM[5'h8][16:0]};	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :83:35, :84:35]
        exe_reg_ctrl_br_type = _RANDOM[5'h8][20:17];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :84:35, :85:39]
        exe_reg_ctrl_alu_fun = _RANDOM[5'h8][27:24];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :84:35, :87:35]
        exe_reg_ctrl_wb_sel = _RANDOM[5'h8][29:28];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :84:35, :88:35]
        exe_reg_ctrl_rf_wen = _RANDOM[5'h8][30];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :84:35, :89:39]
        exe_reg_ctrl_mem_val = _RANDOM[5'h8][31];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :84:35, :90:39]
        exe_reg_ctrl_mem_fcn = _RANDOM[5'h9][0];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :91:39]
        exe_reg_ctrl_mem_typ = _RANDOM[5'h9][3:1];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :91:39, :92:39]
        exe_reg_ctrl_csr_cmd = _RANDOM[5'h9][6:4];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :91:39, :93:39]
        mem_reg_valid = _RANDOM[5'h9][7];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :91:39, :96:39]
        mem_reg_pc = {_RANDOM[5'h9][31:8], _RANDOM[5'hA][7:0]};	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :91:39, :97:35]
        mem_reg_inst = {_RANDOM[5'hA][31:8], _RANDOM[5'hB][7:0]};	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :97:35, :98:35]
        mem_reg_alu_out = {_RANDOM[5'hB][31:8], _RANDOM[5'hC][7:0]};	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :98:35, :99:35]
        mem_reg_wbaddr = _RANDOM[5'hC][12:8];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :99:35, :100:35]
        mem_reg_rs1_addr = _RANDOM[5'hC][17:13];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :99:35, :101:35]
        mem_reg_rs2_addr = _RANDOM[5'hC][22:18];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :99:35, :102:35]
        mem_reg_op1_data = {_RANDOM[5'hC][31:23], _RANDOM[5'hD][22:0]};	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :99:35, :103:35]
        mem_reg_op2_data = {_RANDOM[5'hD][31:23], _RANDOM[5'hE][22:0]};	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :103:35, :104:35]
        mem_reg_rs2_data = {_RANDOM[5'hE][31:23], _RANDOM[5'hF][22:0]};	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :104:35, :105:35]
        mem_reg_ctrl_rf_wen = _RANDOM[5'hF][23];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :105:35, :106:39]
        mem_reg_ctrl_mem_val = _RANDOM[5'hF][24];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :105:35, :107:39]
        mem_reg_ctrl_mem_fcn = _RANDOM[5'hF][25];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :105:35, :108:39]
        mem_reg_ctrl_mem_typ = _RANDOM[5'hF][28:26];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :105:35, :109:39]
        mem_reg_ctrl_wb_sel = _RANDOM[5'hF][30:29];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :105:35, :110:35]
        mem_reg_ctrl_csr_cmd = {_RANDOM[5'hF][31], _RANDOM[5'h10][1:0]};	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :105:35, :111:39]
        wb_reg_valid = _RANDOM[5'h10][2];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :111:39, :114:39]
        wb_reg_wbaddr = _RANDOM[5'h10][7:3];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :111:39, :115:35]
        wb_reg_wbdata = {_RANDOM[5'h10][31:8], _RANDOM[5'h11][7:0]};	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :111:39, :116:35]
        wb_reg_ctrl_rf_wen = _RANDOM[5'h11][8];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :116:35, :117:39]
        if_reg_killed = _RANDOM[5'h11][9];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :116:35, :145:31]
        mem_tval_inst_ma_REG = {_RANDOM[5'h11][31:10], _RANDOM[5'h12][9:0]};	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :116:35, :390:31]
        csr_io_tval_REG = {_RANDOM[5'h12][31:10], _RANDOM[5'h13][9:0]};	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :390:31, :440:91]
        reg_interrupt_handled = _RANDOM[5'h13][10];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :440:91, :447:39]
        wb_reg_inst = {_RANDOM[5'h13][31:11], _RANDOM[5'h14][10:0]};	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :440:91, :518:29]
        REG = {_RANDOM[5'h14][31:11], _RANDOM[5'h15][10:0]};	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :518:29, :523:14]
        REG_1 = _RANDOM[5'h15][15:11];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :523:14, :527:14]
        REG_2 = {_RANDOM[5'h15][31:16], _RANDOM[5'h16][15:0]};	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :523:14, :528:14]
        REG_3 = _RANDOM[5'h16][20:16];	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :528:14, :529:14]
        REG_4 = {_RANDOM[5'h16][31:21], _RANDOM[5'h17][20:0]};	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7, :528:14, :530:14]
      `endif // RANDOMIZE_REG_INIT
    end // initial
    `ifdef FIRRTL_AFTER_INITIAL	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7]
      `FIRRTL_AFTER_INITIAL	// @[generators/riscv-sodor/src/main/scala/sodor/rv32_5stage/dpath.scala:52:7]
