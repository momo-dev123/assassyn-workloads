...
module CSRFile(	// @[generators/rocket-chip/src/main/scala/rocket/CSR.scala:377:7]
  ...
  `ifndef SYNTHESIS	// @[generators/rocket-chip/src/main/scala/rocket/CSR.scala:1021:9]
    wire [2:0] _GEN_2 = {1'h0, {1'h0, insn_ret} + {1'h0, insn_call}} + {1'h0, {1'h0, insn_break} + {1'h0, io_exception}};	// @[generators/rocket-chip/src/main/scala/rocket/CSR.scala:893:83, :1021:18]
    always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/rocket/CSR.scala:1021:9]
      if (~reset & (|(_GEN_2[2:1]))) begin	// @[generators/rocket-chip/src/main/scala/rocket/CSR.scala:1021:{9,18,79}]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/rocket/CSR.scala:377:7]
    ...
    initial begin	// @[generators/rocket-chip/src/main/scala/rocket/CSR.scala:377:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/rocket/CSR.scala:377:7]
        ...
        reg_wfi = _RANDOM[6'h37][7];	// @[generators/rocket-chip/src/main/scala/rocket/CSR.scala:377:7, :575:54]
        reg_mcountinhibit = _RANDOM[6'h37][20:18];	// @[generators/rocket-chip/src/main/scala/rocket/CSR.scala:377:7, :575:54, :590:34]
        small_0 = _RANDOM[6'h37][26:21];	// @[generators/rocket-chip/src/main/scala/rocket/CSR.scala:377:7, :575:54, generators/rocket-chip/src/main/scala/util/Counters.scala:45:41]
        large_0 = {_RANDOM[6'h37][31:27], _RANDOM[6'h38], _RANDOM[6'h39][20:0]};	// @[generators/rocket-chip/src/main/scala/rocket/CSR.scala:377:7, :575:54, generators/rocket-chip/src/main/scala/util/Counters.scala:50:31]
        small_1 = _RANDOM[6'h39][26:21];	// @[generators/rocket-chip/src/main/scala/rocket/CSR.scala:377:7, generators/rocket-chip/src/main/scala/util/Counters.scala:45:41, :50:31]
        large_1 = {_RANDOM[6'h39][31:27], _RANDOM[6'h3A], _RANDOM[6'h3B][20:0]};	// @[generators/rocket-chip/src/main/scala/rocket/CSR.scala:377:7, generators/rocket-chip/src/main/scala/util/Counters.scala:50:31]
        io_status_cease_r = _RANDOM[6'h3C][20];	// @[generators/rocket-chip/src/main/scala/rocket/CSR.scala:377:7, :1162:31]
      `endif // RANDOMIZE_REG_INIT
    end // initial
