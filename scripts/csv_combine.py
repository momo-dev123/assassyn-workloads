...
df_hls_ass.iloc[3, 0] =  "merge"
df_hls_ass.iloc[4, 0] =  "radix"
df_hls_ass.iloc[5, 0] =  "stencil-2d"
df_hls_base.iloc[5, 0] =  "stencil-2d"

df_hls = pd.merge(df_hls_base, df_hls_ass, on="workloads")
